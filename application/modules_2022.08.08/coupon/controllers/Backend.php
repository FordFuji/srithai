...
class Backend extends CI_Controller {
	...
	public function server_processing() {
        ...
        $results = $this->model_coupon_datatable->coupon_datatable($param);
	...
	public function save_update($id = ''){	
		$data = array(
			...
			'coupon_begin_date' => $this->input->post('coupon_begin_date'),
		...
		/*if(!empty($_FILES['coupon_image'])) {
			$config['upload_path']          = FCPATH.'uploads/coupon/';
			...
			if($this->upload->do_upload('coupon_image')) {
				...
				$config_resize['source_image'] = FCPATH.'uploads/coupon/'.$data_image['file_name'];
				$config_resize['new_image'] = FCPATH.'uploads/coupon/'.$data_image['file_name'];
				...
				$data['coupon_image'] = $data_image['file_name'];
			} else {
