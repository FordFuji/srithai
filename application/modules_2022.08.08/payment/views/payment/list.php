								...
								<table id="data-table" class="table table-striped table-bordered">
						            <thead>
						                <tr>
											...
											<th>Order Datetime Create</th>
											<th>Order Datetime Update</th>
						                </tr>
						            </thead>
						            <tbody>
						            </tbody>
				...
				'columns':[
					...
					},
					{
						...
						render:function(data, type, row){
							var action = '<a href="<?php echo base_url('uploads/payment');?>/' + row['payment_slip'] + '" target="_blank"><img src="<?php echo base_url('uploads/payment');?>/' + row['payment_slip'] + '" width="150"></a>';
