...
class Model_category2_datatable extends CI_Model { 
    ...
    public function __construct() {
     ...
     public function category2_datatable($param){
		...
		$condition = "1=1";
		if(!empty($keyword)){
			$condition .= " and (category2_id like '%{$keyword}%' or category2_name_th like '%{$keyword}%' or category2_name_en like '%{$keyword}%' or category1_name_th like '%{$keyword}%' or category1_name_en like '%{$keyword}%')";
		}
