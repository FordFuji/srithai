			...
			var table = $('#data-table').DataTable({
				...
				'columns':[
					...
					},
					{
						data:'action',
						render:function(data, type, row){
							var action = '<a href="<?php echo site_url('product/backend/category3_form');?>/' + row['category3_id'] + '">Edit</a> / <a href="<?php echo site_url('product/backend/category3_delete');?>/' + row['category3_id'] + '" onclick="return confirm(\'Confirm Delete\');">Delete</a>';
