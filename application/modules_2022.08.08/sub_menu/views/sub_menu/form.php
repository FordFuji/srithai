...
?>                                 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" placeholder="Name" name="sub_menu_name" id="sub_menu_name" value="<?php if(!empty($row)) echo $row->sub_menu_name;?>" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Path</label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" placeholder="Path" name="sub_menu_controller" id="sub_menu_controller" value="<?php if(!empty($row)) echo $row->sub_menu_controller;?>" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Sort</label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" placeholder="Sort" name="sub_menu_sort" id="sub_menu_sort" value="<?php if(!empty($row)) echo $row->sub_menu_sort;?>" required>
                                    </div>
                                </div>
                                <!-- <div class="form-group">
...
?>                                 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div class="radio">
                                            <label>
                                                <input type="radio" name="sub_menu_enable" value="1" <?php if(!empty($row)) { if($row->sub_menu_enable == '1') echo ' checked'; }?> required>
                                                Enable
                                            </label>
                                        </div>
                                        <div class="radio">
                                            <label>
                                                <input type="radio" name="sub_menu_enable" value="0" <?php if(!empty($row)) { if($row->sub_menu_enable == '0') echo ' checked'; }?> required>
                                                Disable
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" placeholder="Link" name="sub_menu_link" id="sub_menu_link" value="<?php if(!empty($row)) echo $row->sub_menu_link;?>" required>
                                    </div>
                                </div>
                                <div class="form-group">
