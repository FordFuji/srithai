                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9 col-md-12 col-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-12">
                                        <div class="input-group search">
                                            <input type="search" class="form-control shadow-none" placeholder="<?php echo get2Lang($this->session->userdata('lang'), 'ค้นหารายการ', 'Search');?>" name="ems" value="<?php echo $this->input->post('ems');?>">
                            ...
                            <div class="headerTB d-none d-sm-block">
                                <div class="row">
                                    <div class="col-3"><?php echo get2Lang($this->session->userdata('lang'), 'เลขที่บาร์โค้ด', 'Barcode Number');?></div>
                                    <div class="col-3"><?php echo get2Lang($this->session->userdata('lang'), 'สถานะ', 'Status');?></div>
                                    <div class="col-2"><?php echo get2Lang($this->session->userdata('lang'), 'วันที่', 'Date');?></div>
                                    <div class="col-2"><?php echo get2Lang($this->session->userdata('lang'), 'สถานที่', 'Place');?></div>
                                    <div class="col-2"><?php echo get2Lang($this->session->userdata('lang'), 'รหัสไปรษณีย์', 'Postal Code');?></div>
                                </div>
                            </div>
...
?>
                                <div class="bodyTB-sub">
                                    <div class="row">
                                        <div class="col-6 d-block d-sm-none"><?php echo get2Lang($this->session->userdata('lang'), 'เลขที่บาร์โค้ด', 'Barcode Number');?></div>
                                        ...
                                        <div class="col-6 d-block d-sm-none"><?php echo get2Lang($this->session->userdata('lang'), 'วันที่', 'Date');?></div>
                                        <div class="col-lg-2 col-md-2 col-6">
                                            <div class="content-middle">
                                            <?php echo $r['status_date'];?> 
                                            </div>
                                        </div>
                                        <div class="col-6 d-block d-sm-none"><?php echo get2Lang($this->session->userdata('lang'), 'สถานที่', 'Place');?></div>
                                        <div class="col-lg-2 col-md-2 col-6">
                                            <div class="content-middle">
                                            <?php echo $r['location'];?> 
                                            </div>
                                        </div>
                                        <div class="col-6 d-block d-sm-none"><?php echo get2Lang($this->session->userdata('lang'), 'รหัสไปรษณีย์', 'Postal Code');?></div>
                                        <div class="col-lg-2 col-md-2 col-6">
                                            <div class="content-middle">
                                            <?php echo $r['postcode'];?> 
                                            </div>
