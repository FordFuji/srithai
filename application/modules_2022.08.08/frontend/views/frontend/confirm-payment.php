                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-12">
                                        ...
                                        <select class="form-select" name="payment_account" required>
                                            ...
                                            <option value="ธนาคารกรุงเทพ 102-3-060971" <?php if(!empty($row)) echo 'selected';?>><?php echo get2Lang($this->session->userdata('lang'), 'ธนาคารกรุงเทพ', 'Bank Bangkok');?> 102-3-060971</option>
                                        </select>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-12">
