            ...
            <div class="col px-0">
                <div class="slide-navButton nav-in">
                    <div class="main-banner owl-carousel owl-theme">
                        <div class="items"><img src="<?php echo base_url('asset/frontend/images/product/banner-category01.jpg');?>"></div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-5 col-12">
                            ...
                            <div class="d-none d-md-none d-lg-block">
                                <div class="input-group search">
                                    <input type="search" class="form-control shadow-none" placeholder="<?php echo get2Lang($this->session->userdata('lang'), 'ค้นหาสินค้า', 'search product');?>" id="search_product1" value="<?php if($this->session->userdata('search_inc') != '') echo $this->session->userdata('search_inc');?>">
                            ...
                            <div class="sub-category-select d-block d-sm-block d-lg-none">
                                <div class="select2-part mb-0">
                                    <select class="js-example-basic-single form-control wrap" name="sub-category" onchange="window.location.href='<?php echo site_url('product_category/'.$category1_id);?>/' + this.value";>
                                        ...
                                        <option value="" <?php if($category2_id == '') echo 'selected';?>><?php echo get2Lang($this->session->userdata('lang'), 'ผลิตภัณฑ์ทั้งหมด', 'All Product');?></option>
<?php
if(!empty($category2)) {
...
?>
                ...
                <div class="category-page">
                    <div class="row">
                        ...
                        <?php /*<div class="col-lg-3 d-none d-md-none d-lg-block">
                            <ul class="category-menu">
                                <li class="active"><a href="<?php echo site_url('product_category/'.$category1_id.'/0');?>">ผลิตภัณฑ์ทั้งหมด</a></li>
<?php
if(!empty($category2)) {
    foreach($category2 as $r) {
?>
                                <li><a href="<?php echo site_url('product_category/'.$r->category1_id.'/'.$r->category2_id);?>"><?php echo get2Lang($this->session->userdata('lang'), $r->category2_name_th, $r->category2_name_en);?></a></li>
<?php
    }
}
?>
