...
?>
                                    <?php /*<a class="item" data-fancybox="gallery" href="images/product/product-m05.jpg"><img src="images/product/product-m05.jpg"></a>
...
?>
                                    <?php /*<div class="item"><img src="images/product/product-m05.jpg"></div>
...
?>                                
                                            <div class="option-list">
                                                <div class="optionBox-name">
                                                    <input type="radio" id="color_<?php echo $r->color_id;?>" name="product-color" value="<?php echo $r->color_id;?>" onclick="clickColor(this.value);">
...
?>                
                                <div class="items">
                                    <div class="productBox">
                                        <div class="row">
                                            <div class="col">
                                                <a class="product-img" href="<?php echo site_url('product-detail/'.$r->product_id);?>"><img src="<?php echo base_url('uploads/product/'.$r->product_image);?>"></a>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col">
...
?>
    ...
    <script type="text/javascript">
        ...
        function clickColor(color_id) {
            //alert(color_id);
            $.post('<?php echo site_url('frontend/path/ajaxClickColor');?>', { product_id: '<?php echo $product_id;?>', color_id: color_id }, function(data) {
                $(".data-size").html(data);
            });
        }
    </script>
