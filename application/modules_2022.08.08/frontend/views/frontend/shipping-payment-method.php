                            ...
                            <div class="bank-info fix-line more-mb2">
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-10">
                                        <p><?php echo get2Lang($this->session->userdata('lang'), 'ธนาคารกรุงเทพ', 'Bank Bangkok');?></p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col">
                                    <ul class="list-decimal more-mb4">
                                        ...
                                        <li><?php echo get2Lang($this->session->userdata('lang'), 'ให้คุณโอนเงินเท่ากับราคารวมของรายการสั่งซื้อ พร้อมเก็บหลักฐานการโอนเงิน', 'You transfer money equal to the total price of the order. with proof of transfer');?>
                                            <ol>
                                                <li>
                                                    <p><strong><?php echo get2Lang($this->session->userdata('lang'), 'ธนาคารกรุงเทพ', 'Bank Bangkok');?></strong></p>
                                                    <p><?php echo get2Lang($this->session->userdata('lang'), 'สาขาราชวงศ์ | ประเภทกระแสรายวัน | ชื่อบัญชี บมจ. ศรีไทยซุปเปอร์แวร์ | เลขที่บัญชี', 'Ratchawong Branch | Current type | Account name Srithai Superware PCL. | Account number');?> 102-3-060971</p>
                                                </li>
                                            </ol>
                                        </li>
