			...
			<div class="wrap-pad">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-2 col-12">
                        <a class="buttonR readmore" href="<?php echo site_url('promotion');?>">ดูเพิ่มเติม</a>
                    </div>
                </div>
                <div class="row">
					<div class="col">
...
?>
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-2 col-12">
                        <a class="buttonR readmore" href="<?php echo site_url('bundles');?>">ดูเพิ่มเติม</a>
                    </div>
                </div>
                <div class="row">
					<div class="col">
...
?>
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-2 col-12">
                        <a class="buttonR readmore" href="<?php echo site_url('flexi_combo');?>">ดูเพิ่มเติม</a>
                    </div>
                </div>
                <div class="row">
					<div class="col">
...
?>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-2 col-12">
                        <a class="buttonR readmore" href="<?php echo site_url('recommended');?>">ดูเพิ่มเติม</a>
                    </div>
                </div>
                <div class="row">
					<div class="col">
...
?>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-2 col-12">
                        <a class="buttonR readmore" href="<?php echo site_url('new_arrivals');?>">ดูเพิ่มเติม</a>
                    </div>
                </div>
                <div class="row">
					<div class="col">
                            ...
                            <div class="categoryBox">
                                ...
                                <div class="category-txt">
                                    ...
                                    <div class="content-center">
                                        <a class="buttonR round" href="<?php echo site_url('product_category/'.$r->category1_id);?>">ดูเพิ่มเติม</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="items">
                                        <div class="productBox">
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="product-topic">
                                                        <p><?php echo get2Lang($this->session->userdata('lang'), $p->category1_name_th, $p->category1_name_en);?></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                ...
                                <div class="items">
                                    <div class="customerBox">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="content-center">
                                                    <a class="button-txt" href="<?php echo site_url('customer_group/'.$r->customer_group_id);?>">ดูสินค้า</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="row">
                    <div class="col">
                        <div class="content-center mb-4">
                            <a class="buttonR medium" href="<?php echo site_url('article');?>">ดูบทความทั้งหมด</a>
                        </div>
                    </div>
                </div>
            </div>
