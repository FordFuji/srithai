                                                        ...
                                                        <div class="menu-slider">
                                                            <div class="menu">
                                                                <ul>
                                                                    ...
                                                                    <li data-page="point">
                                                                        <div class="menu-item"><a href="<?php echo site_url('member-point');?>">คะแนนสะสม</a></div>
                                                                    </li>
        ...
        <div class="row">
            <div class="col">
                <ul class="member-menu">
                    <li data-page="profile"><a href="<?php echo site_url('member_profile');?>">บัญชีของฉัน</a></li>
                    <li data-page="address"><a href="<?php echo site_url('member_address');?>">ที่อยู่จัดส่ง</a></li>
                    <li data-page="point"><a href="<?php echo site_url('member_point');?>">คะแนนสะสม</a></li>
                    <?php /*<li data-page="payment"><a href="<?php echo site_url('member_payment');?>">การชำระเงิน</a></li>*/ ?>
                    <li data-page="order"><a href="<?php echo site_url('member_order');?>">รายการสั่งซื้อ</a></li>
                    <li><a href="<?php echo site_url('confirm_payment');?>">แจ้งโอนเงิน</a></li>
                    <li>
                        <button class="logout-button" onclick="window.location.href='<?php echo site_url('frontend/path/logout');?>';"><i class="fas fa-sign-out-alt"></i>ออกจากระบบ</button>
                    </li>
                </ul>
            </div>
        </div> 
