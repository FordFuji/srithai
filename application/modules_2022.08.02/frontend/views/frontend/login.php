                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="header-wCaption">
                                                <h5><i class="fas fa-lock"></i>เข้าสู่ระบบด้วยบัญชีศรีไทยออนไลน์</h5>
...
?>
                                                <li>
                                                    <button class="button-google" onclick="window.location.href='<?php echo $google_client->createAuthUrl();?>';"><img src="<?php echo base_url('asset/frontend/images/icon/icon-google.svg');?>">เข้าสู่ระบบผ่าน GOOGLE</button>
                                                </li>
                                                <li>
                                                    <button class="button-facebook" onclick="fbLogin();"><i class="fab fa-facebook-f"></i>เข้าสู่ระบบผ่าน FACEBOOK</button>
                                                </li>
                                                <li>
                                                    ยังไม่เคยลงทะเบียน ? <a href="javascript:showRegister();">ลงทะเบียน</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="grayBox" id="show_register" style="display: none;">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <button class="buttonBK" onclick="register();">สมัครสมาชิก</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <div class="content-center">
                        <button type="button" class="buttonBK" onclick="forgetPassword();">ยืนยัน</button>
