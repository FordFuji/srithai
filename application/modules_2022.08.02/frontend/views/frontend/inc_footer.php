...
?>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <ul class="footer-menu">
                                            <li><a href="<?php echo site_url('contact');?>">ช่องทางการติดต่อ</a></li>
                                            <li><a href="<?php echo site_url('shipping_payment_method');?>#shipping">การจัดส่งสินค้า</a></li>
                                            <li><a href="<?php echo site_url('member_order');?>">การตรวจสอบสถานะสินค้า</a></li>
                                            <li><a href="<?php echo site_url('shipping_payment_method');?>#payment">วิธีการชำระเงิน</a></li>
                                            <li><a href="<?php echo site_url('confirm_payment');?>">แจ้งโอนเงิน</a></li>
                                            <li><a href="<?php echo site_url('shipping_payment_method');?>#refund">การคืนเงินหรือเปลี่ยนสินค้า</a></li>
                                        </ul>
                                    </div>
                                </div>
<?php
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <ul class="footer-menu">
                                                        ...
                                                        <li><a href="<?php echo site_url('member-order');?>">การตรวจสอบสถานะสินค้า</a></li>
                                                        <li><a href="<?php echo site_url('shipping-payment-method');?>#payment">วิธีการชำระเงิน</a></li>
                                                        <li><a href="<?php echo site_url('confirm-payment');?>">แจ้งโอนเงิน</a></li>
                                                        <li><a href="<?php echo site_url('shipping-payment-method');?>#refund">การคืนเงินหรือเปลี่ยนสินค้า</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
