                ...
                <div class="row justify-content-center">
                    <div class="col-xl-10 col-lg-12 col-md-12 col-12">
                        <div class="cart-topic">
                            <div class="row">
                                <div class="col-lg-6 d-none d-md-none d-lg-block">สินค้า</div>
                                <div class="col-lg-2 d-none d-md-none d-lg-block">ราคา</div>
                                <div class="col-lg-2 d-none d-md-none d-lg-block">จำนวน</div>
                                <div class="col-lg-2 d-none d-md-none d-lg-block">ราคารวม</div>
                                <div class="col-md-12 d-block d-md-block d-lg-none">สินค้า</div>
                            </div>
                        </div>
...
?>
                        ...
                        <div class="cart-form pad">
                            <div class="row">
                                <div class="col-lg-7 col-md-7 col-8">ราคาสินค้า</div>
...
?>
                            <div class="row">
                                <div class="col-lg-7 col-md-7 col-8">ค่าขนส่ง</div>
...
?>
                            <div class="row">
                                <div class="col-lg-7 col-md-7 col-8">ส่วนลด 
                                    <span id="coupon">
<?php
if($this->session->userdata('coupon_price') != '') {
?>
                                        <br>(Coupon: <?php echo number_format($this->session->userdata('coupon_price'), 2, '.', ',');?> บาท)
<?php
}
?>
                                    </span> 
...
?>
                                        <br>(Multiple Price Level: <?php echo number_format($this->session->userdata('multiple_price_level_discount'), 2, '.', ',');?> บาท)
<?php
}
?>
                                    </span> 
...
?>
                                        <br>(Promotion Special Rule: <?php echo number_format($this->session->userdata('special_promotion_rule_discount'), 2, '.', ',');?> บาท)
<?php
}
?>
                                    </span> 
...
?>
                                        <br>(Discount Category Rule: <?php echo number_format($this->session->userdata('discount_category_discount'), 2, '.', ',');?> บาท)
<?php
}
?>
                                    </span> 
...
?>
                                        <br>(Data Point : <?php echo number_format($this->session->userdata('data_point_discount'), 2, '.', ',');?> บาท)
<?php
}
?>
                                    </span> 
...
?>
                                        <br>(VIP: <?php echo number_format($this->session->userdata('vip_discount_price'), 2, '.', ',');?> บาท)
<?php
}
?>
                                    </span></div>
...
?>
                            <div class="row">
                                <div class="col-lg-7 col-md-7 col-8">รวม</div>
                        ...
                        <div class="checkout-section">
                            <div class="button-pair">
                                <div class="row">
                                    <div class="col">
                                        <a class="buttonG" href="<?php if(!empty($category_product_first)) echo site_url('product_category/'.$category_product_first->category1_id);?>">เลือกดูสินค้าต่อ</a>

                                        <a class="buttonR" href="javascript:checkMemberId();">สั่งซื้อสินค้า</a>
                                    </div>
                                </div>
                            </div>
