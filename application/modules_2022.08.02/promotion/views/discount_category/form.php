...
?>
							<form action="<?php echo site_url('promotion/backend/discount_category_save_update/'.$id);?>" method="post" enctype="multipart/form-data" class="form-horizontal">
					        <div class="form-group">
					            <label class="col-md-3 control-label">Category1(Th) / Category1(En)</label>
					            <div class="col-md-9">
...
?>
							...
							<div class="form-group">
					            ...
					            <div class="col-md-9">
                       				<input type="number" name="discount_category_discount" id="discount_category_discount" class="form-control" value="<?php if(!empty($row)) echo $row->discount_category_discount;?>">
								</div>
							</div>
							<div class="form-group">
	...
	<script>
		...
		function resetForm() {
			$(".form-control").val('');
			CKEDITOR.instances.discount_category_ckeditor.setData('');
		}

		function changeCategory1(category1_id) {
			$.post('<?php echo site_url('promotion/backend/ajaxChangeCategory1');?>', { category1_id: category1_id }, function(data) {
