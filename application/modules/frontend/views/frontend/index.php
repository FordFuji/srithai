...
<body>
    ...
    <!---------- INDEX :: POP UP ---------->
<?php
if(!empty($popup) and $popup->popup_image != '') {
?>
    <a href="#main-popup" class="main-popup" data-fancybox></a>
    <div class="main-popupphoto" id="main-popup">
        <a href="<?php echo $popup->popup_link;?>"><img src="<?php echo base_url('uploads/popup/'.$popup->popup_image);?>" class="img-fluid" alt=""></a>
    </div>
<?php
}
?>
...
?>
                                                <div class="price" style="color: red;">THB <?php echo number_format($r->product_price, 0, '.', ',');?></div>
...
?>
                                                    <div class="price" style="color: red;">THB <?php echo number_format($p->product_price, 0, '.', ',');?></div>
				...
				<div class="row">
					<div class="col">
                        <div class="header-wCaption center more-mb3">
                            <h1><?php echo get2Lang($this->session->userdata('lang'), 'กลุ่มสินค้าที่คัดสรรมาเป็นพิเศษ', 'Specially selected products');?></h1>
