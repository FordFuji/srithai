    ...
    <div class="content-padding foot-pad">
        <div class="container-fluid">
            <div class="wrap-pad">
                <div class="row">
                    <div class="col">
                        <h2 class="decor"><?php if(!empty($status)) echo $status;?></h2>
                    </div>
                </div>
                <!-- <div class="row">
                    <div class="col">
...
?>
                            <div class="row">
                                <div class="col-md-2">
                                    <img src="<?php echo base_url('uploads/bank/'.$b->bank_image);?>">
                                </div>
                                <div class="col-md-10">
<?php
        if($this->session->userdata('lang') == 'th') {
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="content-center">
                                <a class="buttonG" href="<?php echo site_url('index');?>"><?php echo get2Lang($this->session->userdata('lang'), 'กลับหน้าแรก', 'Back');?></a>
