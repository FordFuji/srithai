...
?>
							...
							<div class="form-group">
								...
								<div class="col-md-5">
                       				<input type="number" name="shipping_price_1000_2" id="shipping_price_1000_2" class="form-control" value="<?php if(!empty($row2)) echo $row2->shipping_price_1000;?>" required>
					            </div>
					        </div>
					        <div class="form-group">
								...
								<div class="col-md-5">
                       				<input type="number" name="shipping_price_1000_1999_2" id="shipping_price_1000_1999_2" class="form-control" value="<?php if(!empty($row2)) echo $row2->shipping_price_1000_1999;?>" required>
					            </div>
					        </div>
							<div class="form-group">
								...
								<div class="col-md-5">
                       				<input type="number" name="shipping_price_2000_2999_2" id="shipping_price_2000_2999_2" class="form-control" value="<?php if(!empty($row2)) echo $row2->shipping_price_2000_2999;?>" required>
					            </div>
					        </div>
							<div class="form-group">
								...
								<div class="col-md-5">
                       				<input type="number" name="shipping_price_3000_3999_2" id="shipping_price_3000_3999_2" class="form-control" value="<?php if(!empty($row2)) echo $row2->shipping_price_3000_3999;?>" required>
					            </div>
					        </div>
							<div class="form-group">
								...
								<div class="col-md-5">
                       				<input type="number" name="shipping_price_4000_4999_2" id="shipping_price_4000_4999_2" class="form-control" value="<?php if(!empty($row2)) echo $row2->shipping_price_4000_4999;?>" required>
					            </div>
					        </div>
							<div class="form-group">
								...
								<div class="col-md-5">
                       				<input type="number" name="shipping_price_5000_5999_2" id="shipping_price_5000_5999_2" class="form-control" value="<?php if(!empty($row2)) echo $row2->shipping_price_5000_5999;?>" required>
					            </div>
					        </div>
							<div class="form-group">
								...
								<div class="col-md-5">
                       				<input type="number" name="shipping_price_6000_6999_2" id="shipping_price_6000_6999_2" class="form-control" value="<?php if(!empty($row2)) echo $row2->shipping_price_6000_6999;?>" required>
					            </div>
					        </div>
							<div class="form-group">
								...
								<div class="col-md-5">
                       				<input type="number" name="shipping_price_7000_7999_2" id="shipping_price_7000_7999_2" class="form-control" value="<?php if(!empty($row2)) echo $row2->shipping_price_7000_7999;?>" required>
					            </div>
					        </div>
							<div class="form-group">
								...
								<div class="col-md-5">
                       				<input type="number" name="shipping_price_8000_8999_2" id="shipping_price_8000_8999_2" class="form-control" value="<?php if(!empty($row2)) echo $row2->shipping_price_8000_8999;?>" required>
					            </div>
					        </div>
							<div class="form-group">
								...
								<div class="col-md-5">
                       				<input type="number" name="shipping_price_9000_9999_2" id="shipping_price_9000_9999_2" class="form-control" value="<?php if(!empty($row2)) echo $row2->shipping_price_9000_9999;?>" required>
					            </div>
					        </div>
							<div class="form-group">
								...
								<div class="col-md-5">
                       				<input type="number" name="shipping_price_10000_10999_2" id="shipping_price_10000_10999_2" class="form-control" value="<?php if(!empty($row2)) echo $row2->shipping_price_10000_10999;?>" required>
					            </div>
					        </div>
							<div class="form-group">
								...
								<div class="col-md-5">
                       				<input type="number" name="shipping_price_11000_11999_2" id="shipping_price_11000_11999_2" class="form-control" value="<?php if(!empty($row2)) echo $row2->shipping_price_11000_11999;?>" required>
					            </div>
					        </div>
							<div class="form-group">
								...
								<div class="col-md-5">
                       				<input type="number" name="shipping_price_12000_12999_2" id="shipping_price_12000_12999_2" class="form-control" value="<?php if(!empty($row2)) echo $row2->shipping_price_12000_12999;?>" required>
					            </div>
					        </div>
							<div class="form-group">
								...
								<div class="col-md-5">
                       				<input type="number" name="shipping_price_13000_13999_2" id="shipping_price_13000_13999_2" class="form-control" value="<?php if(!empty($row2)) echo $row2->shipping_price_13000_13999;?>" required>
					            </div>
					        </div>
							<div class="form-group">
								...
								<div class="col-md-5">
                       				<input type="number" name="shipping_price_14000_14999_2" id="shipping_price_14000_14999_2" class="form-control" value="<?php if(!empty($row2)) echo $row2->shipping_price_14000_14999;?>" required>
					            </div>
					        </div>
							<div class="form-group">
								...
								<div class="col-md-5">
                       				<input type="number" name="shipping_price_15000_15999_2" id="shipping_price_15000_15999_2" class="form-control" value="<?php if(!empty($row2)) echo $row2->shipping_price_15000_15999;?>" required>
					            </div>
					        </div>
							<div class="form-group">
								...
								<div class="col-md-5">
                       				<input type="number" name="shipping_price_16000_16999_2" id="shipping_price_16000_16999_2" class="form-control" value="<?php if(!empty($row2)) echo $row2->shipping_price_16000_16999;?>" required>
					            </div>
					        </div>
							<div class="form-group">
								...
								<div class="col-md-4">
                       				<input type="number" name="shipping_price_17000_17999_2" id="shipping_price_17000_17999_2" class="form-control" value="<?php if(!empty($row2)) echo $row2->shipping_price_17000_17999;?>" required>
					            </div>
					        </div>
							<div class="form-group">
								...
								<div class="col-md-5">
                       				<input type="number" name="shipping_price_18000_18999_2" id="shipping_price_18000_18999_2" class="form-control" value="<?php if(!empty($row2)) echo $row2->shipping_price_18000_18999;?>" required>
					            </div>
					        </div>
							<div class="form-group">
								...
								<div class="col-md-5">
                       				<input type="number" name="shipping_price_19000_19999_2" id="shipping_price_19000_19999_2" class="form-control" value="<?php if(!empty($row2)) echo $row2->shipping_price_19000_19999;?>" required>
					            </div>
					        </div>
							<!-- <div class="form-group">
								...
								<div class="col-md-5">
                       				<input type="number" name="shipping_price_20000_100000000_2" id="shipping_price_20000_100000000_2" class="form-control" value="<?php if(!empty($row2)) echo $row2->shipping_price_20000_100000000;?>" required>
					            </div>
					        </div> -->
							<div class="form-group">
								<label class="col-md-3 control-label"> </label>
