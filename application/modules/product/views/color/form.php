...
?>
							...
							<div class="form-group">
					            ...
					            <div class="col-md-9">
                       				<input type="text" name="color_name_th" id="color_name_th" class="form-control" value="<?php if(!empty($row)) echo $row->color_name_th;?>" required>
					            </div>
					        </div>
							<div class="form-group">
					            <label class="col-md-3 control-label">Name(En)</label>
					            <div class="col-md-9">
                       				<input type="text" name="color_name_en" id="color_name_en" class="form-control" value="<?php if(!empty($row)) echo $row->color_name_en;?>" required>
					            </div>
					        </div>
					        <div class="form-group">
