<?php
$link_social = $this->model_frontend->getLinkSocialResult();
?>
                                ...
                                <ul class="contact-info">
                                    ...
                                    <li>
                                        <div>
                                            ...
                                            <p><?php if(!empty($contact_us_inc)) echo '<a href="mailto:'.$contact_us_inc->contact_us_email.'">'.$contact_us_inc->contact_us_email.'</a>';?><?php /*<a href="mailto:contact@srithaisuperware.com">contact@srithaisuperware.com</a>*/ ?></p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                ...
                <div class="row">
                    <div class="col">
                        <div class="content-center">
                            <ul class="social">
                                <li><a href="<?php if(!empty($link_social)) echo $link_social->link_social_facebook;?>" target="_blank"><i class="fab fa-facebook-f"></i></a></li>
                                <li><a href="<?php if(!empty($link_social)) echo $link_social->link_social_twitter;?>" target="_blank"><i class="fab fa-twitter"></i></a></li>
                                <li><a href="<?php if(!empty($link_social)) echo $link_social->link_social_instagram;?>"><i class="fab fa-instagram"></i></a></li>
                                <li><a href="<?php if(!empty($link_social)) echo $link_social->link_social_line;?>" target="_blank"><img src="<?php echo base_url('asset/frontend/images/icon/icon-lineGY.svg');?>"></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<!-- Cookie Consent -->
<!-- OneTrust Cookies Consent Notice start for www.srithaionline.com -->

<script src="https://cdn-apac.onetrust.com/scripttemplates/otSDKStub.js"  type="text/javascript" charset="UTF-8" data-domain-script="d6ec49e0-e244-4eb0-bfe0-a233f8074dbf" ></script>
...
<!-- OneTrust Cookies Consent Notice end for www.srithaionline.com -->
