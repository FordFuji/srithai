                ...
                <div class="member-section">
                    <div class="row">
                        ...
                        <div class="col-lg-9 col-md-12 col-12">
                            <div class="row">
                                <div class="col">
                                    <h4><?php echo get2Lang($this->session->userdata('lang'), 'คะแนนสะสม', 'Point');?></h4>
                                </div>
                            </div>
                                ...
                                <div class="col-xl-7 col-lg-8 col-md-7 col-12">
                                    <div class="pointBox">
                                        <div class="pointBox-content">
                                            <div class="row">
                                                <div class="col">
                                                    <h5><?php echo get2Lang($this->session->userdata('lang'), 'ยอดคะแนนสะสม', 'Point Amount');?></h5>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col">
                                                    <div class="my-point">
                                                        <p><span><?php if(!empty($point_all)) echo $point_all; else echo 0;?></span><?php echo get2Lang($this->session->userdata('lang'), 'คะแนน', 'Point');?></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="headerTB d-none d-sm-block">
                                        <div class="row">
                                            <div class="col-4"><?php echo get2Lang($this->session->userdata('lang'), 'วันที่ได้รับ', 'Receive Date');?></div>
                                            <div class="col-4"><?php echo get2Lang($this->session->userdata('lang'), 'เลขที่คำสั่งซื้อ', 'Order No');?></div>
                                            <div class="col-4"><?php echo get2Lang($this->session->userdata('lang'), 'คะแนน', 'Point');?></div>
                                        </div>
                                    </div>
                                    <div class="bodyTB">
<?php
...
?>
                                        <div class="bodyTB-sub">
                                            <div class="row">
                                                <div class="col-6 d-block d-sm-none"><?php echo get2Lang($this->session->userdata('lang'), 'วันที่ได้รับ', 'Receive Date');?></div>
                                                ...
                                                <div class="col-6 d-block d-sm-none"><?php echo get2Lang($this->session->userdata('lang'), 'คะแนน', 'Point');?></div>
                                                <div class="col-lg-4 col-md-4 col-6">
                                                    <div class="content-middle">
