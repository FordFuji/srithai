                        ...
                        <div class="col-lg-9 col-md-12 col-12">
                            <div class="row">
                                <div class="col-lg-7 col-md-6 col-8">
                                    <h4><?php echo get2Lang($this->session->userdata('lang'), 'ที่อยู่การจัดส่ง', 'Shipping Address');?></h4>
                                </div>
                                <div class="col-lg-5 col-md-6 col-4">
                                    <!---------- ADD NEW ADDRESS ---------->
                                    <button type="button" class="button-add" data-toggle="modal" data-target="#addNew"><i class="fas fa-plus-circle"></i><?php echo get2Lang($this->session->userdata('lang'), 'เพิ่มที่อยู่ใหม่', 'Add new Address');?></button>
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h6><?php echo get2Lang($this->session->userdata('lang'), 'เพิ่มที่อยู่ใหม่', 'Add new Address');?></h6>
...
?>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-12">
                                                                <p><?php echo get2Lang($this->session->userdata('lang'), 'เขต/อำเภอ', 'District');?></p> <!-- DISTRICT -->
                                                                <div class="select2-part">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-12">
                                                                <p><?php echo get2Lang($this->session->userdata('lang'), 'แขวง/ตำบล', 'Sub District');?></p> <!-- SUB-DISTRICT -->
                                                                <div class="select2-part">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-12">
                                                                <p><?php echo get2Lang($this->session->userdata('lang'), 'รหัสไปรษณีย์', 'Postal Code');?></p> <!-- POSTAL CODE -->
                                                                <div class="select2-part">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="buttonBK" onclick="saveMemberShipping();"><?php echo get2Lang($this->session->userdata('lang'), 'ยืนยัน', 'Confirm');?></button>
                            ...
                            <div class="infoBox">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-6">
                                        <h6><?php echo get2Lang($this->session->userdata('lang'), 'ที่อยู่', 'Address');?> <?php echo $i;?></h6>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-6">
...
?>
                                            <li><?php echo get2Lang($this->session->userdata('lang'), 'เบอร์โทรศัพท์', 'Telephone Number');?> : <?php echo $r->member_shipping_tel;?></li>
                                            <li><?php echo get2Lang($this->session->userdata('lang'), 'อีเมล์', 'Email');?> : <?php echo $r->member_shipping_email;?></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col">
                                        <ul class="edit-option">
                                            <li>
                                                ...
                                                <button type="button" data-toggle="modal" data-target="#changeAdd<?php echo $r->member_shipping_id;?>"><i class="fas fa-pen"></i><?php echo get2Lang($this->session->userdata('lang'), 'แก้ไข', 'Edit');?></button>
                                            </li>
                                            <li>
                                                <button class="remove" onclick="deleteMemberShipping('<?php echo $r->member_shipping_id;?>');"><i class="fas fa-trash-alt"></i><?php echo get2Lang($this->session->userdata('lang'), 'ลบ', 'Delete');?></button>
                                            </li>
                                        </ul>
                                        <!-- Modal -->
                                        <div class="modal fade form-modal" id="changeAdd<?php echo $r->member_shipping_id;?>" data-backdrop="static" data-keyboard="false" aria-labelledby="changeName" aria-hidden="true">
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h6><?php echo get2Lang($this->session->userdata('lang'), 'แก้ไขที่อยู่', 'Edit Address');?> <?php echo $i;?></h6>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <i class="fas fa-times"></i>
                                                        </button>
                                                    </div>
...
?>                                                         
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="buttonBK" onclick="saveMemberShipingID('<?php echo $r->member_shipping_id;?>')"><?php echo get2Lang($this->session->userdata('lang'), 'ยืนยัน', 'Confirm');?></button>
                                                        <button type="button" class="buttonBD" data-dismiss="modal"><?php echo get2Lang($this->session->userdata('lang'), 'ยกเลิก', 'Cancel');?></button>
                                                    </div>
                                                </div>
                                            </div>
