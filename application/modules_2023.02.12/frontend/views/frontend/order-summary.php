    ...
    <div class="content-padding foot-pad">
        <div class="container-fluid">
            <div class="wrap-pad">
                <div class="row">
                    <div class="col">
                        <h2 class="decor"><?php echo get2Lang($this->session->userdata('lang'), 'สรุปรายละเอียดการสั่งซื้อ', 'Order Summary');?></h2>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <div class="order-number"><?php echo get2Lang($this->session->userdata('lang'), 'หมายเลขคำสั่งซื้อ', 'Order No');?> : <span><?php if(!empty($row)) echo $row->order_no;?></span></div>
                    </div>
                </div>
...
?>
                                                ...
                                                <li><?php echo get2Lang($this->session->userdata('lang'), 'เบอร์โทรศัพท์', 'Telephone Number');?> : <?php if(!empty($row)) echo $row->order_tel;?></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="row">
                                        <div class="col">
                                            <h6><?php echo get2Lang($this->session->userdata('lang'), 'วันที่สั่งซื้อสินค้า', 'Date');?></h6>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col">
...
?>
                            ...
                            <div class="point-form">
                                <div class="row">
                                    <div class="col-lg-7 col-md-7 col-8"><?php echo get2Lang($this->session->userdata('lang'), 'คะแนนสะสม', 'Point Amount');?></div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <h6><?php echo get2Lang($this->session->userdata('lang'), 'วิธีการชำระเงิน', 'Payment Method');?></h6>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="content-center">
                                <a class="buttonG" href="<?php echo site_url('index');?>"><?php echo get2Lang($this->session->userdata('lang'), 'กลับหน้าแรก', 'Back to Home');?></a>
                                <a class="buttonR" href="<?php echo site_url('confirm_payment/'.$order_id);?>"><?php echo get2Lang($this->session->userdata('lang'), 'แจ้งชำระเงิน', 'Payment');?></a>
                            </div>
                        </div>
                    </div>
                </div>
