                ...
                <div class="row">
                    <div class="col">
                        <ul class="bread-crumb">
                            ...
                            <li><a href="<?php echo site_url('product_category/'.$row->category1_id);?>"><?php if(!empty($row)) echo get2Lang($this->session->userdata('lang'), $row->category1_name_th, $row->category1_name_en);?></a></li>
                            <li><a href="<?php echo site_url('product_category/'.$row->category1_id.'/'.$row->category2_id);?>"><?php if(!empty($row)) echo get2Lang($this->session->userdata('lang'), $row->category2_name_th, $row->category2_name_en);?></a></li>
                            <li><a><?php if(!empty($row)) echo get2Lang($this->session->userdata('lang'), $row->product_name_th, $row->product_name_en);?></a></li>
                        </ul>
                    </div>
                </div>
...
if(!empty($photo)) {
    foreach($photo as $r) {
?>
                                    <a class="item" data-fancybox="gallery" href="<?php echo base_url('uploads/product_photo/'.$r->product_photo_image);?>"><img src="<?php echo base_url('uploads/product_photo/'.$r->product_photo_image);?>"></a>
<?php
    }
}
?>
                                    <?php /*<a class="item" data-fancybox="gallery" href="<?php echo base_url('asset/frontend/images/product/product-m01.jpg');?>"><img src="<?php echo base_url('asset/frontend/images/product/product-m01.jpg');?>"></a>
                                    <a class="item" data-fancybox="gallery" href="<?php echo base_url('asset/frontend/images/product/product-m05.jpg');?>"><img src="<?php echo base_url('asset/frontend/images/product/product-m05.jpg');?>"></a>
                                    <a class="item" data-fancybox="gallery" href="<?php echo base_url('asset/frontend/images/product/product-m06.jpg');?>"><img src="<?php echo base_url('asset/frontend/images/product/product-m06.jpg');?>"></a>*/ ?>
                                </div>
...
if(!empty($photo)) {
    foreach($photo as $r) {
?>
                                    <div class="item"><img src="<?php echo base_url('uploads/product_photo/'.$r->product_photo_image);?>"></div>
<?php
    }
}
?>
                                    <?php /*<div class="item"><img src="<?php echo base_url('asset/frontend/images/product/product-m01.jpg');?>"></div>
                                    <div class="item"><img src="<?php echo base_url('asset/frontend/images/product/product-m05.jpg');?>"></div>
                                    <div class="item"><img src="<?php echo base_url('asset/frontend/images/product/product-m06.jpg');?>"></div>*/ ?>
                                </div>
                            </div>
                        </div>
                        <!---------- PRODUCT :: INFO ---------->
                        <div class="col-xl-7 col-lg-6 col-md-11 col-12">
                            <div class="product-info">
                                <div class="row">
                                    <div class="col">
                                        <h3><?php if(!empty($row)) echo get2Lang($this->session->userdata('lang'), $row->product_name_th, $row->product_name_en);?></h3>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col">
<?php
if($row->product_price != $row->product_price_before_discount) {
?>
                                        <div class="price">THB <?php if(!empty($row)) echo number_format($row->product_price, 0, '.', ',');?></div>
                                        <div class="full-price">THB <?php if(!empty($row)) echo number_format($row->product_price_before_discount, 0, '.', ',');?></div>
...
?>
                                        <div class="discount"><b>THB <?php if(!empty($row)) echo number_format($row->product_price, 0, '.', ',');?></b></div>
<?php   
}
?>
                                    </div>
...
?>
                                            <div class="option-list">
                                                <div class="optionBox-name">
                                                    <input type="radio" id="color_<?php echo $r->color_id;?>" name="product-color" value="<?php echo $r->color_id;?>" onclick="clickColor(this.value, '<?php echo $product_id;?>');">
                                                    <label for="color_<?php echo $r->color_id;?>"><?php echo get2Lang($this->session->userdata('lang'), $r->color_name_th, $r->color_name_en);?></label>
                                                </div>
                                            </div>
<?php
    }
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="sp-quantity big">
                                                <div class="sp-minus btnquantity decrease_<?php echo $row->product_id;?>" onclick="decrease('<?php echo $row->product_id;?>');"><i class="fas fa-minus"></i></div>
                                                <div class="sp-input">
                                                    <input type="text" class="quntity-input" id="qty_<?php echo $row->product_id;?>" value="1" />
                                                </div>
                                                <div class="sp-plus btnquantity" increase_<?php echo $row->product_id;?>" onclick="increase('<?php echo $row->product_id;?>');"><i class="fas fa-plus"></i></div>
                                            </div>
<?php
if(!empty($color)) {
...
?>
                                            <button class="buttonR big" onclick="addToCart('<?php echo $product_id;?>');"><i class="fas fa-shopping-cart"></i>ADD TO CART</button>
<?php   
    }
}
?>
                                            ...
                                            <div class="panel panel-default">
                                                ...
                                                <div id="p-detail" class="panel-collapse collapse show" role="tabpanel" data-parent="#accordion">
                                                    <div class="panel-body">
                                                        <?php if(!empty($row)) echo get2Lang($this->session->userdata('lang'), $row->product_descriptions_th, $row->product_descriptions_en);?>
    ...
    <div class="content-padding">
        <div class="container-fluid">
			<div class="wrap-pad">
                <div class="row">
					<div class="col">
                        <h2><?php echo get2Lang($this->session->userdata('lang'), 'สินค้าอื่นๆ', 'RELATED PRODUCTS');?></h2>
                    </div>
                </div>
                <div class="row">
					<div class="col">
...
?>
                                <div class="items">
                                    <div class="productBox">
                                        <div class="row">
                                            <div class="col">
                                                <a class="product-img" href="<?php echo site_url('product_detail/'.$r->map_product_related_product_id);?>"><img src="<?php echo base_url('uploads/product/'.$r->product_image);?>"></a>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col">
...
?>
                                        <div class="row">
                                            <div class="col">
<?php
        $color_size = $this->model_frontend->get_product_map_product($r->map_product_related_product_id);
...
?>
                                                <button type="button" class="button-cart" data-toggle="modal" data-target="#addCart-option-<?php echo $r->map_product_related_product_id;?>"><span>ADD TO CART</span></button>
<?php
            }
...
?>
    ...
    <script type="text/javascript">
        ...
        function addToCart(product_id) {
            $.post('<?php echo site_url("frontend/path/ajaxInsertCart");?>', { product_id: product_id, qty: $("#qty_" + product_id).val() }, function(data) {
