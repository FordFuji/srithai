    ...
    <div class="content-padding foot-pad">
        <div class="container-fluid">
            <div class="wrap-pad">
                <div class="row">
                    <div class="col">
                        <h2><?php echo get2Lang($this->session->userdata('lang'), 'การจัดส่งสินค้า & การชำระเงิน', 'Shipping & Payment');?></h2>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-8 col-12">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="headerBK">
                                    <div class="headerBK-topic"><?php echo get2Lang($this->session->userdata('lang'), 'ที่อยู่สำหรับจัดส่ง', 'Delivery Address');?></div>
                                </div>
                            </div>
                        </div>
                        <div align="right"><a href="<?php echo site_url('member_address');?>"><button type="button" class="button-add"><i class="fas fa-plus-circle"></i><?php echo get2Lang($this->session->userdata('lang'), 'เพิ่มที่อยู่ใหม่', 'Add New Address');?></button></a></div>
                        <div class="row">
                            <div class="col">
                                                ...
                                                <div class="md-radio md-radio-inline radiocheck">
                                                    ...
                                                    <label for="shipping_default">
                                                        ...
                                                        <?php 
                                                            if(!empty($shipping_address)) { 
                                                        ?>
                                                            <strong><?php echo $shipping_address->member_shipping_name.' '.$shipping_address->member_shipping_surname;?><span>(<?php echo get2Lang($this->session->userdata('lang'), 'ที่อยู่ตั้งต้น', 'Default Address');?>)</span></strong>
                                                        <?php 
                                                            } else {
                                                        ?>
                                                            <span>(<?php echo $shipping_address->member_shipping_id;?>)</span>    
                                                        <?php
                                                            } 
                                                        ?>
                                                        </p>
...
?>
                                                                        ...
                                                                        <p><?php echo get2Lang($this->session->userdata('lang'), 'เบอร์โทรศัพท์', 'Telephone Number');?> : <?php if(!empty($shipping_address)) { echo $shipping_address->member_shipping_tel; } ?></p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
...
?>
                                                                            ...
                                                                            <p><?php echo get2Lang($this->session->userdata('lang'), 'เบอร์โทรศัพท์', 'Telephone Number');?> : <?php if(!empty($shipping_address)) { echo $spnd->member_shipping_tel; } ?></p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="billing-section">
                                                <div class="row">
                                                    <div class="col-10"><?php echo get2Lang($this->session->userdata('lang'), 'ที่อยู่ขอใบเสร็จ/ใบกำกับภาษี', 'Address for receipt/tax invoice');?></div>
                                                    <!-- SWITCH BUTTON -->
                                                    <div class="col-2">
                                                ...
                                                <div class="box01" <?php if($this->session->userdata('switch') == 'Yes') echo 'style="display: block;"';?>>
                                                    <div class="accBDbottom noneBD none-bottomBD">
                                                        <div class="input-form">
                                                            ...
                                                            <div class="row">
                                                                <div class="col">
                                                                    <p><?php echo get2Lang($this->session->userdata('lang'), 'เลขที่ผู้เสียภาษี', 'Tax number');?></p>
                                                            ...
                                                            <div class="row">
                                                                <div class="col">
                                                                    <p><?php echo get2Lang($this->session->userdata('lang'), 'ที่อยู่', 'Address');?></p>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-6 col-md-6 col-12">
                                                                    <p><?php echo get2Lang($this->session->userdata('lang'), 'จังหวัด', 'Province');?></p> <!-- PROVINCE -->
                                                                    <div class="select2-part">
...
?>
                                                                ...
                                                                <div class="col-lg-6 col-md-6 col-12">
                                                                    <p><?php echo get2Lang($this->session->userdata('lang'), 'เขต / อำเภอ', 'District');?></p> <!-- POSTAL CODE -->
                                                                    <div class="select2-part">
...
?>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-6 col-md-6 col-12">
                                                                    <p><?php echo get2Lang($this->session->userdata('lang'), 'แขวง / ตำบล', 'Sub District');?></p> <!-- DISTRICT -->
                                                                    <div class="select2-part">
...
?>                                                                                
                                                                ...
                                                                <div class="col-lg-6 col-md-6 col-12">
                                                                    <p><?php echo get2Lang($this->session->userdata('lang'), 'รหัสไปรษณีย์', 'Postal Code');?></p> <!-- SUB-DISTRICT -->
                                                                    <div class="select2-part">
...
?>                                                     
                                                                ...
                                                                <div class="col-lg-12 col-md-12 col-12">
                                                                    <p><?php echo get2Lang($this->session->userdata('lang'), 'เลือกที่อยู่สำหรับจัดส่งใบกำกับภาษี', 'Choose Address For Billing');?></p>
                                                                </div>
                                                                <div class="col-lg-6 col-md-6 col-12">
                                                                    <input type="radio" name="order_address_for_billing" id="order_address_for_shipping"> ที่อยู่ตามการจัดส่งสินค้า
                                                                </div>
                                                                <div class="col-lg-6 col-md-6 col-12">
                                                                    <input type="radio" name="order_address_for_billing" id="order_address_for_billing"> ที่อยู่ตามใบกำกับภาษี
                                                                </div>
                                                            </div>
                                    ...
                                    <!-- <div class="row">
                                        <div class="col">
                                            <div class="input-form">
                                                <p><?php echo get2Lang($this->session->userdata('lang'), 'หมายเหตุ (ถ้ามี)', 'Note (if any)');?></p>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="headerBK">
                                    <div class="headerBK-topic"><?php echo get2Lang($this->session->userdata('lang'), 'วิธีการจัดส่ง', 'Shipping Method');?></div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                ...
                                <div class="shipping-option shipped-section">
                                    <div class="accordion">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="md-radio md-radio-inline radiocheck mb-0">
                                                    <input id="shipping_express" type="radio" name="shipping-group" <?php if($this->session->userdata('shipping_type') == 'new' and $this->session->userdata('order_shipping_method') == 'Express') echo 'checked';?> checked onclick="checkShipping('express');" />
                                                    <label for="shipping_express">
                                                        <div class="row">
                                                            <div class="col-lg-9 col-md-10 col-8">
                                                                <p><strong>Standard Delivery - <?php echo get2Lang($this->session->userdata('lang'), 'ส่งแบบธรรมดา', 'Normal Delivery');?></strong></p>
                                                                <div class="txt-content f-14">
                                                                    <p><?php echo get2Lang($this->session->userdata('lang'), 'จัดส่งสินค้าภายใน 3-7 วันทำการ หลังจากสั่งซื้อสินค้า', 'Ships within 3-7 business days after ordering.');?></p>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-3 col-md-2 col-4">THB <span class="shipping_price2"><?php echo number_format($this->session->userdata('order_shipping_text'), 0, '.', ',');?></span></div>
                                                        </div>
                                                    </label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="md-radio md-radio-inline radiocheck">
                                                    <input id="shipping_me" type="radio" name="shipping-group" <?php if($this->session->userdata('shipping_type') == 'new' and $this->session->userdata('order_shipping_method') == 'shipping_me') echo 'checked';?> onclick="checkShipping('me');" />
                                                    <label for="shipping_me">
                                                        <div class="row">
                                                            <div class="col-lg-9 col-md-10 col-8">
                                                                <p><strong>รับสินค้าด้วยตัวเอง</strong></p>
                                                                <!-- <div class="txt-content f-14">
                                                                    <p>จัดส่งสินค้าภายใน 7-10 วันทำการ หลังจากสั่งซื้อสินค้า</p>
                                                                </div> -->
                                                            </div>
                                                            <div class="col-lg-3 col-md-2 col-4">THB 0</div>
                                                        </div>
                                                    </label>
                                                </div>
                                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="headerBK">
                                    <div class="headerBK-topic"><?php echo get2Lang($this->session->userdata('lang'), 'วิธีการชำระเงิน', 'Payment Method');?></div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                            ...
                                            <div class="col">
                                                <div class="md-radio md-radio-inline radiocheck">
                                                    ...
                                                    <label for="credit_card">
                                                        <p><strong><?php echo get2Lang($this->session->userdata('lang'), 'ชำระเงินผ่านบัตรเครดิต', 'Credit Card');?></strong></p>
                                                    </label>
                                                    <?php /*<section>
                                                        <div class="accBDbottom">
                                                            <div class="input-form">
                                            ...
                                            <div class="col">
                                                <div class="md-radio md-radio-inline radiocheck mb-0">
                                                    ...
                                                    <label for="bank_transfer">
                                                        <p><strong><?php echo get2Lang($this->session->userdata('lang'), 'โอนเงินผ่านธนาคาร', 'Bank Transfer');?></strong></p>
                                                    </label>
                                                    <section>
                                                        <div class="accBDbottom none-bottomBD">
                                                            <div class="bank-info">
...
?>
                    ...
                    <div class="col-lg-4 col-12">
                        ...
                        <div class="row">
                                <div class="col">
                                    <h4><?php echo get2Lang($this->session->userdata('lang'), 'สรุปรายการสินค้า', 'Product List Summary');?></h4>
                                </div>
                            </div>
...
?>
                            ...
                            <div class="redeem-point">
                                <div class="row">
                                    <div class="col">
                                        <p><?php echo get2Lang($this->session->userdata('lang'), 'คุณมี', 'You have ');?><strong><?php if(!empty($point)) echo number_format($point, 0, '.', ','); else echo 0;?></strong><?php echo get2Lang($this->session->userdata('lang'), 'คะแนน', 'Point');?> <?php echo get2Lang($this->session->userdata('lang'), 'สามารถใช้แลกเป็นส่วนลดได้', 'can be redeemed for a discount');?></p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col">
                                        <select class="form-select" id="product-status" onchange="changePoint(this.value);">
                                            <option value="" <?php if($this->session->userdata('data_point') == '') echo 'selected';?>><?php echo get2Lang($this->session->userdata('lang'), 'เลือก', 'Select');?></option>
<?php
if(!empty($point)) {
...
?>
                            ...
                            <div class="cart-form">
                                <div class="row">
                                    <div class="col-lg-7 col-md-7 col-8"><?php echo get2Lang($this->session->userdata('lang'), 'ยอดรวม', 'Sub Total');?></div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="content-center">
                                <a class="buttonG" href="<?php if(!empty($category_product_first)) echo site_url('product_category/'.$category_product_first->category1_id);?>"><?php echo get2Lang($this->session->userdata('lang'), 'เลือกซื้อสินค้าต่อ', 'Continue shopping');?></a>
                                <?php /*<a class="buttonR" href="<?php echo site_url('order-summary');?>">ดำเนินการชำระเงิน</a>*/ ?>
                                <a class="buttonR cart-checkout" href="javascript:checkout();"><?php echo get2Lang($this->session->userdata('lang'), 'ดำเนินการชำระเงิน', 'Process the payment');?></a>
                            </div>
                        </div>
                    </div>
                </div>
...
?>
        function clickNewAddress(member_shipping_id) {
            ...
            if($("#shipping_new_" + member_shipping_id).is(":checked") == true) {
                ...
                $.post('<?php echo site_url("frontend/path/ajaxClickNewAddress");?>', { member_shipping_id: member_shipping_id }, function(data) {
                    var data_split = data.split('!@#$%^&*()');

                    $(".inc_qty_basket").html(data_split[0]);
                    $(".sub_total_price").html(data_split[1]);
                    $(".shipping_price").html(data_split[2]);
                    $(".shipping_price2").html(Math.floor(data_split[14]));
        ...
        function checkout() {
            ...
            if($("#shipping_default").is(":checked") == false && $(".shipping_new").is(":checked") == false) {
            ...
            }*/ else if($("#shipping_express").is(":checked") == false && $("#shipping_me").is(":checked") == false) {
            ...
            } else if($("#switch").is(":checked") == true && $("#order_address_for_shipping").is(":checked") == false && $("#order_address_for_billing").is(":checked") == false) {
                alert('<?php echo get2Lang($this->session->userdata('lang'), 'เลือกที่อยู่สำหรับจัดส่งใบกำกับภาษี', 'CHOOSE ADDRESS FOR BILLING');?>');

                $("#order_address_for_shipping").focus();
                ...
                } else if($("#shipping_me").is(":checked") == true) {
                    shipping_method = 'รับสินค้าด้วยตัวเอง';
                }

                if($("#order_address_for_shipping").is(":checked") == true) {
                    order_address_for_billing ="ที่อยู่ตามการจัดส่งสินค้า";
                } else if($("#order_address_for_billing").is(":checked") == true) {
                    order_address_for_billing ="ที่อยู่ตามใบกำกับภาษี";
                }
                    ...
                    /*if(shipping == 'default') {
                        ...
                        if($("#switch").is(":checked") == true) {
                            ...
                            $.post('<?php echo site_url("frontend/path/ajaxCheckout");?>', { 
                                ...
                                order_address_billing: order_address_for_billing,
                                switch: 'Yes'
                            }, function(data) {
                                $("#orderRef").val(data);
                                $("#successUrl").val('<?php echo site_url('frontend/path/success');?>/' + data);
...
<?php
if($this->session->userdata('order_shipping') == '') {
?>
        $(document).ready(function() {
            $.post('<?php echo site_url("frontend/path/ajaxShippingPriceOnLoad");?>', function(data) {
                var data_split = data.split('!@#$%^&*()');
...
?>
        /*$(document).ready(function() {
            if($(".shipping_new").is(":checked") == true) {

            }
        });*/

        function checkShipping(shipping_type) {
            // me, express
            $.post('<?php echo site_url("frontend/path/ajaxCheckShipping");?>', { shipping_type: shipping_type }, function(data) {
                var data_split = data.split('!@#$%^&*()');
