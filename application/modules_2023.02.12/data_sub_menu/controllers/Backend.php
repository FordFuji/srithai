...
class Backend extends CI_Controller {
	...
	public function __construct() {
		...
		$this->load->model('data_sub_menu/model_data_sub_menu');
		$this->load->model('data_sub_menu/model_ford_datatable');
	...
	public function ford() {
		...
		/* start body */
		$this->load->view('data_sub_menu/ford/list', $data);
		/* end body */
	}
	
	public function ford_server_processing() {
	...
	public function ford_form($id = ''){	
		$data['id'] = $id;
		$data['row'] = $this->model_data_sub_menu->get_ford_single($id);
		...
		$this->load->view('data_sub_menu/ford/form', $data);
	}
	
	public function ford_save_update($id = ''){	
		$data = array(
		...
		// update 
		if($id != '') {	
			$this->model_data_sub_menu->update_ford($data, $id);
			
			redirect('data_sub_menu/backend/ford', 'location');
		...
		// insert
			...
			$this->model_data_sub_menu->insert_ford($data);
			
			redirect('data_sub_menu/backend/ford', 'location');
		}
	}
	
	public function ford_delete($id){
		$this->model_data_sub_menu->delete_ford($id);
