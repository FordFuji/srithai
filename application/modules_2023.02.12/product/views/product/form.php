...
?>           
							...
							<div class="form-group">
					            ...
					            <div class="col-md-9">
                       				<input type="radio" name="product_enable" id="product_enable" value="Enable" <?php if(!empty($row) and $row->product_enable == 'Enable') echo 'checked';?> required> Enable
									   <input type="radio" name="product_enable" id="product_enable" value="Disable" <?php if(!empty($row) and $row->product_enable == 'Disable') echo 'checked';?> required> Disable
					            </div>
					        </div>
