...
?>
							<form action="<?php echo site_url('ford/backend/ford_save_update/'.$id);?>" method="post" enctype="multipart/form-data" class="form-horizontal">
...
?>           
					        ...
					        <div class="form-group">
					            ...
					            <div class="col-md-9">
                       				<textarea name="ford_ckeditor" id="ford_ckeditor" class="form-control" required><?php if(!empty($row)) echo $row->ford_ckeditor;?></textarea>
