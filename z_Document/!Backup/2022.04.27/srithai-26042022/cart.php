            ...
            <div class="wrap-pad">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-10 col-lg-12 col-md-12 col-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-9 col-8">
                                        ...
                                        <div class="d-md-block d-lg-none">
                                            <div class="row">
                                                <div class="col">
                                                    <div class="price sale">฿ 655</div>
                                                    <div class="full-price">฿ 699</div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-5 col-12">
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="กรอกรหัสคูปอง" aria-describedby="coupon-code">
                                            <button class="buttonBK" type="button" id="coupon-code">ยืนยัน</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <!---------- COUPON - SECTION :: FOR IPAD & MOBILE ---------->
                        ...
                        <div class="checkout-section">
                            <div class="button-pair">
                                <div class="row">
                                    <div class="col">
                                        <a class="buttonG" href="product-category.php">เลือกดูสินค้าต่อ</a>

                                        <a class="buttonR" href="shipping-payment.php">สั่งซื้อสินค้า</a>
                                    </div>
                                </div>
                            </div>
                        </div>
