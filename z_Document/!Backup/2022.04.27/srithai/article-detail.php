        ...
        <div class="row">
            <div class="col px-0">
                <div class="top-banner">
                    <img src="images/article/banner-article.jpg">
			...
			<div class="wrap-pad">    
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12 col-md-11 col-12">
                        <h4>หัวข้อบทความ หัวข้อบทความ หัวข้อบทความ หัวข้อบทความ หัวข้อบทความ หัวข้อบทความ หัวข้อบทความ หัวข้อบทความ หัวข้อบทความ</h4>
                    </div>
                </div>
                <div class="row justify-content-center">
                    <div class="col-lg-12 col-md-11 col-12">
                        <div class="article-date">12 FEB 2022</div>
                    </div>
                </div>
                <div class="row justify-content-center">
                    <div class="col-lg-10 col-md-11 col-12">
                        <div class="img-width more-mb3"><img src="images/article/article04.jpg"></div>
                    </div>
                </div>
                <div class="row justify-content-center">
                    <div class="col-lg-12 col-md-11 col-12">
                ...
                <div class="row">
                    <div class="col">
                        <div class="content-center">
                            <a class="buttonBD" href="article.php">ย้อนกลับ</a>
                        </div>
                    </div>
                </div>
