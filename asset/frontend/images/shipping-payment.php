                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="billing-section">
                                                <div class="row">
                                                    <div class="col-10">ที่อยู่เรียกเก็บเงิน</div>
                                                    <!-- SWITCH BUTTON -->
                                                    <div class="col-2">
                    ...
                    <div class="col-lg-4 col-12">
                        <div class="summaryBox">
                            ...
                            <div class="redeem-point">
                                <div class="row">
                                    <div class="col">
                                        <p>คุณมี<strong>100</strong>คะแนน สามารถใช้แลกเป็นส่วนลดได้</p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col">
                                        <select class="form-select" id="product-status">
                                            <option selected>เลือก</option>
                                            <option value="1">50 คะแนน 50 บาท</option>
                                            <option value="2">100 คะแนน 100บาท</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
